...
\begin{document}
    ...
    La structure tridimensionnelle choisie est un pont pour lequel nous avons cherché à minimiser l'épaisseur du pont
    ...
    La géométrie de ce problème est tridimensionnelle et sa coupe verticale est montré dans la Figure \ref{fig:problem}. %referencier la figure
    \begin{figure}[H]        
    \begin{center}
	
        \includegraphics[width=12cm]{coupe_2D-schema.JPG}
        \caption{Schéma de la géométrie du pont. Une force $f= - 5x10^8 N m^(-2)$ est appliquée à sa surface supérieure. Le déplacement maximale $d$ est montré en bleue. Le système est qui est soumis à la gravité $g$.}
        \label{fig:problem}
